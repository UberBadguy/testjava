                            ...
                            <div class="active tab-pane" id="activity">
                                <c:forEach items="${servicios}" var="servicio">           
                                    <div class="box box-default">
                                        ...
                                        <div class="box-body">
                                            <div class="clearfix">
                                                <span class="pull-left">Ubicación Piso 1 - ${servicio.detalle}</span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="addNew" data-controller="espaciosComunes" data-url="reservaEstacionamiento.htm">Guardar</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div>
