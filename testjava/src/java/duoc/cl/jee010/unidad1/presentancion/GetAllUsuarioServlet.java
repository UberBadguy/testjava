...
public class GetAllUsuarioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //List<Usuario>listadoUsuario=objUsuarioBO.getAllUser();
        List<UsuarioPerfilDTO>listadoUsuario=objUsuarioBO.getAllUserPerfilDTO();
        sesion.setAttribute("listadoUsuario", listadoUsuario);
    }
