...
import duoc.cl.jee010.unidad1.dto.ProductoVentaUsuarioDTO;
...
import duoc.cl.jee010.unidad1.negocio.ProductoBO;
import duoc.cl.jee010.unidad1.utilidades.Utilitaria;
...
public class AgregarCarritoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Ventas objVenta = new Ventas(codigo, cantidad, objProducto.getId_producto(), objUsuario.getId_usuario());

        ProductoVentaUsuarioDTO objProductoVentaUsuarioDTO = new ProductoVentaUsuarioDTO(objProducto.getId_producto(),
                objUsuario.getId_usuario(), objProducto.getNombre_producto(), objProducto.getMarca_producto(), objProducto.getPrecio_producto(),
                objVenta.getCodigo_venta(), objVenta.getCantidad_venta(), objUsuario.getLogin_usuario());
